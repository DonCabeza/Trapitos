    ...
    <div class="menu-contenedor">
        ...
        <?php } elseif ($rol === "empleado") { ?>
            ...
            <table class="Opciones">
                ...
                <tr>
                    <td colspan="2"><a href="descuentos_ver.php" class="accion">Ver Promociones Activas</a></td>
                </tr>
                ...
                <tr>
                    <td><a href="proveedores_mostrar.php" class="accion">Directorio de Proveedores</a></td>
